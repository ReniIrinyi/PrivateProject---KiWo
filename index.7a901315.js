...
!(function () {
  function a(e) {
    ...
    var a = e.target,
      i = (function (e) {
        var t,
          ...
          o = Object.keys(n)
            .filter(function (e) {
              return "honeypot" !== n[e].name || ((t = n[e].value), !1);
            })
            .map(function (e) {
              return void 0 !== n[e].name
                ? n[e].name
                : n[e].length > 0
                ? n[e].item(0).name
                : "file" == n[e].type
        ...
        return (
          o.forEach(function (e) {
            var t = n[e];
            if (((r[e] = t.value), t.length)) {
              for (var o = [], a = 0; a < t.length; a++) {
                var i = t.item(a);
                (i.checked || i.selected) && o.push(i.value);
              }
              r[e] = o.join(", ");
            }
          }),
          (r.formDataNameOrder = JSON.stringify(o)),
          (r.formGoogleSheetName = e.dataset.sheet || "responses"),
          (r.formGoogleSendEmail = e.dataset.email || ""),
          { data: r, honeypot: t }
        );
      })(a),
      u = i.data;
    ...
    !(function (e) {
      for (var t = e.querySelectorAll("button"), n = 0; n < t.length; n++)
        t[n].disabled = !0;
    })(a);
    var d = a.action,
    ...
    l.open("POST", d),
      ...
      (l.onreadystatechange = function () {
        if (4 === l.readyState && 200 === l.status) {
          a.reset();
          var e = a.querySelector(".form-elements");
          e && (e.style.display = "none");
          var t = a.querySelector(".thankyou_message");
