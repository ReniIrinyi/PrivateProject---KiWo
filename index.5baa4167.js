...
const createDots = function() {
    sliderCompontents.forEach((s, i)=>{
        dots.insertAdjacentHTML("beforeend", `<button class="slider-dot" data-slide="${i}"></button>`);
    });
};
createDots();
