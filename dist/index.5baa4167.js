...
const createDots = function() {
    sliderCompontents.forEach((s, i)=>{
        dots.insertAdjacentHTML("beforeend", `<button class="slider-dots--dot" data-slide="${i}"></button>`);
    });
};
createDots();
const activateDots = function(slide) {
    document.querySelectorAll(".slider-dots--dot").forEach((dot)=>dot.classList.remove("slider-dots--dot__active"));
    document.querySelector(`.slider-dots--dot[data-slide="${slide}"]`).classList.add("slider-dots--dot__active");
};
activateDots(0);
let currentSlide = 0;
